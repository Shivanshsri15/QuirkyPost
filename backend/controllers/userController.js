...
const searchUser = asyncHandler(async (req, res) => {
  ...
  if (!searchtext) {
    res.status(400);
    throw new Error("Please provide a search text");
  }
...
export { registerUser, authUser, logOut, updateProfile,followAndunfollowUser,getUserSavedBlogs,getUserById,searchUser };
