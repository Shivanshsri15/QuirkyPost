...
const MainNavbar = () => {
  ...
  return (
    <Navbar expand="lg" className=" p-0 " data-bs-theme={isDarkMode?"dark":"light"}>
        ...
        <Container className="text-center ms-5 ps-5 page-body">
          ...
          <Navbar.Collapse >
            <Nav className="mx-auto px-auto text-white">
              ...
              <Button fluid onClick={toggleTheme} className="bg-transparent lead" style={{border:"none",color:"white"}}>
                {isDarkMode ? <MdLightMode className="fs-5"/> : <MdOutlineLightMode className="fs-5"/>}
              </Button>
              <Form className="ms-5 ps-5 d-flex">
                <Form.Group>
                  ...
                  />
                              ...
                              <Button variant="outline-light" style={{ fontSize: "12px",height:"fit-content" }}
                              className="mt-1 ms-2">
                                  Search
                              </Button>
              </Form>
