...
const MainBlogBox = ({ id, title, postImage, content, author, date, user }) => {
  return (
    <div
      className="page-body rounded boxShadow"
      style={{ width: "fit-content", height: "fit-content" }}
    >
      <Card
        className="p-1 mb-2  page-body card-Body shadow text-hover"
        id={id}
        style={{ width: "15rem" }}
      >
          ...
          <Card.Footer>
            <Row className="p-0">
              <Col className="p-0">
                ...
                <p
                  className="ms-5 ps-5 pt-3 mb-0 text-end"
                  style={{ fontSize: "10px" }}
                >
                  {date}
                </p>
