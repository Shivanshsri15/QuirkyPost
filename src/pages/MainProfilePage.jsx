...
import { useGetSavedUserBlogQuery, useGetUserQuery } from "../slices/usersApiSlice";
const MainProfilePage = () => {
  ...
  return (
    <Container className="page-body " fluid>
      <ProfileBox blogsLength={blogsData?.length} user={mainUserData} userLoading={userLoading } />
